...
export default function MentorAuth() {
  ...
  const handleGoogleAuth = () => {
    window.location.href = "http://localhost:3000/auth/google?role=mentor";
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-20 w-64 h-64 bg-gradient-to-br from-purple-400/20 to-pink-400/20 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 right-20 w-80 h-80 bg-gradient-to-bl from-pink-400/20 to-purple-400/20 rounded-full blur-3xl"></div>
      </div>
        ...
        <div className="bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl border border-gray-100 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              {isLogin
                ? "Continue guiding the next generation with CareerCompass"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
                ...
                <>
                  ...
                  {isLogin ? "Sign In as Mentor" : "Become a Mentor"}
                </>
              )}
            </button>
          </form>
