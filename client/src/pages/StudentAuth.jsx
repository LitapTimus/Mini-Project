...
export default function StudentAuth() {
  ...
  const handleGoogleAuth = () => {
    window.location.href = "http://localhost:3000/auth/google?role=student";
  };
        ...
        <div className="bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl border border-gray-100 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              {isLogin
                ? "Continue your learning journey with CareerCompass"
                : "Start exploring career paths and connect with mentors"}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-blue-600 to-green-600 text-white py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
