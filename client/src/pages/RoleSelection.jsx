  ...
  const roles = [
    {
      id: "student",
      title: "Student",
      description: "Explore career paths, find opportunities, and get guidance from mentors",
      icon: FiBookOpen,
      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Select how you'd like to use Career Compass. This helps us personalize your experience.
          </p>
        </div>
            ...
            return (
              ...
              >
                <div className="text-center">
                  {/* Icon */}
                  <div className={`w-20 h-20 bg-gradient-to-r ${role.color} rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg`}>
                  ...
                  {/* Select Button */}
                  <button className={`bg-gradient-to-r ${role.color} text-white px-8 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200`}>
                    Select {role.title}
                  </button>
                </div>
              </div>
